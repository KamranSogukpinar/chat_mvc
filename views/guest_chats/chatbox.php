      ...
      <div class="bg-white">
        ...
        <div class="messages-box">
          <div class="list-group rounded-0">
             ...
             <a href="/guest/chatbox/<?php echo $users['id']; ?>" <?php if($users['role']== 'admin') echo 'class="list-group-item list-group-item-action active text-white rounded-0"'; else echo  'class="list-group-item list-group-item-action text-grey rounded-0"';?>">
              <div class="media"><img src="https://res.cloudinary.com/mhmd/image/upload/v1564960395/avatar_usae7z.svg" alt="user" width="40" class="rounded-circle">
                <div class="media-body ml-4">
                  ...
                  <p class="font-italic mb-0 text-small"><?php echo $users['profession'];?></h6></p>
                </div>
              </div>
            </a>
            <?php endforeach; ?>
...
<ul id="messages"><?php echo $chat_history;?></ul>
      ...
      <form action="#" method="post" class="bg-light">
        <div class="input-group">
          ...
          <input type="text" name="chat_message" placeholder="Текст" aria-describedby="button-addon2" class="form-control rounded-0 border-0 py-4 bg-light">
