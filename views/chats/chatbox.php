        ...
        <div class="messages-box">
          <div class="list-group rounded-0">
          	<?php foreach ($users as $users): ?>
               <a href="/chatbox/<?php echo $users['id']; ?>" <?php if($users['role']== 'admin') echo 'class="list-group-item list-group-item-action active text-white rounded-0"'; else echo  'class="list-group-item list-group-item-action text-grey rounded-0"';?>">
